...
<form id="form1" name="form1" method="post" action="">
  ...
  预订时间：
  <input name="yudingshijian1" type="text" id="yudingshijian1"  value='' onclick="getDate(form1.yudingshijian1,'2')" size="10" need="1" />
  -
  <input name="yudingshijian2" type="text" id="yudingshijian2"  value='' onclick="getDate(form1.yudingshijian2,'2')" size="10" need="1" />
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from jiudianyuding where yudingren='".$_SESSION['username']."'";
...
<p align="center"><a href="jiudianyuding_list2.php?pagecurrent=1">首页</a>, <a href="jiudianyuding_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="jiudianyuding_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="jiudianyuding_list2.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>

<p>&nbsp; </p>
<p>已有路线预订列表：</p>
<table width="600" border="1"  cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
  <thead>
    <tr  bgcolor="#CCFFFF">
      <th>订单编号</th>
      <th>路线名</th>
  ...
  <tbody>
  <?php
$sql = "SELECT * FROM booktourline where username='".$_SESSION['username']."'";
