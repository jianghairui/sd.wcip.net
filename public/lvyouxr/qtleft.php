                ...
                <td><table id="__01" width="208" height="230" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="208" height="37" background="qtimages/1_02_01_01_01.jpg"><table width="100%" height="23" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="70%" height="23" align="center" valign="bottom"><span class="STYLE1">系统公告</span></td>
                ...
                <td><table id="__01" width="208" height="209" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="208" height="46" background="qtimages/1_02_01_02_01.jpg"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="92%" height="16" align="center" valign="top"><span class="STYLE4">用户登陆</span></td>
                          ...
                          <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td align="center"><input type="button" name="Submit3" value="退出" onclick="javascript:location.href='logout.php';" style=" height:19px; border:solid 1px #000000; color:#666666" />
                                  <input type="button" name="Submit22" value="我的订单" onclick="javascript:location.href='main.php';" style=" height:19px; border:solid 1px #000000; color:#666666" /></td>
                            </tr>
                          </table>
                        <?php } ?></td>
                ...
                <td><table id="__01" width="208" height="200" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="208" height="41" background="qtimages/1_02_01_03_01.jpg"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="92%" height="16" align="center" valign="middle"><span class="STYLE4">站内搜索</span></td>
                        <td width="8%" valign="bottom">&nbsp;</td>
                      </tr>
                    </table></td>
                  </tr>
					  ...
					  if($rowscount>0)
					  {
						...
						?>
                              <tr>
                                ...
                                <td height="25">&nbsp;</td>
                                <td width="92%" height="25"><a href="<?php echo mysql_result($query,$i,"wangzhi");?>" target="_blank" ><?php echo mysql_result($query,$i,"wangzhanmingcheng");?></a></td>
                              </tr>
                              <?php
						}
					  }
