                ...
                <td valign="top"><table width="785" height="833" border="0" cellpadding="0" cellspacing="0" id="__01">
                  <tr>
                    <td width="785" height="40" background="qtimages/1_02_02_02_01.jpg"><table width="100%" height="19" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="12%" align="center" valign="bottom"><span class="STYLE4">航班信息</span></td>
  ...
  <input type="submit" name="Submit" value="查找" />
                          ...
                          <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
                            <tr>
                              ...
                              <td bgcolor='#CCFFFF'>班机号</td>
                              <td bgcolor='#CCFFFF'>始发地</td>
                              <td bgcolor='#CCFFFF'>目的地</td>
                              <td bgcolor='#CCFFFF'>票价</td>
                              <td bgcolor='#CCFFFF'>起飞时间</td>
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ?>
	...
	echo $i+1;
?></td>
                              <td><?php echo mysql_result($query,$i,banjihao);?></td>
                              <td><?php echo mysql_result($query,$i,shifadi);?></td>
                              <td><?php echo mysql_result($query,$i,mudedi);?></td>
                              <td><?php echo mysql_result($query,$i,piaojia);?></td>
                              <td><?php echo mysql_result($query,$i,qifeishijian);?></td>
...
?>
	...
	?>
                          ...
                          <p align="center"><a href="hangbanxinxilist.php?pagecurrent=1">首页</a>, <a href="hangbanxinxilist.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="hangbanxinxilist.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="hangbanxinxilist.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>                          <p align="center">&nbsp;</p>                          
                        </td>
